...
impl Linear2D {
    ...
    pub fn is_parallel_approx(&self, l: &Linear2D, tol: f32) -> bool {
        crate::utilitiy::approx_equal(self.dir.cross(&l.dir), 0.0, tol)
    }
...
impl Linear3D {
    pub fn is_parallel_approx(&self, l: &Linear3D, tol: f32) -> bool {
        crate::utilitiy::approx_equal(self.dir.cross(&l.dir).length_sqrd(), 0.0, tol)
    }
