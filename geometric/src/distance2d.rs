...
pub fn pt2line_sqrd(pt: &Vec2, line: &Line2D) -> f32 {
    let p = pt2line(pt, &line.start, &line.dir);
    pt2pt_sqrd(&p, pt)
}

pub fn pt2seg_sqrd(pt: &Vec2, seg: &Segment2D) -> f32 {
    let p = pt2segment(pt, seg);
    pt2pt_sqrd(&p, pt)
}

pub fn pt2ray_sqrd(pt: &Vec2, ray: &Ray2D) -> f32 {
    let p = pt2ray(pt, ray);
    pt2pt_sqrd(&p, pt)
}
...
pub fn pt2triangle_sqrd(pt: &Vec2, triangle: Triangle2D) -> Option<f32> {
    todo!()
}

pub fn line2line_sqrd(l1: &Line2D, l2: &Line2D) -> Option<f32> {
...
pub fn ray2line_sqrd(l: &Line2D, ray: &Line2D) -> Option<f32> {
...
pub fn line2seg_sqrd(l: &Line2D, seg: &Line2D) -> Option<f32> {
...
pub fn seg2seg_sqrd(_s1: &Line2D, _s2: &Line2D) -> Option<f32> {
    todo!();
}

pub fn ray2ray_sqrd(_r1: &Line2D, _r2: &Line2D) -> Option<f32> {
    todo!();
}

pub fn ray2seg_sqrd(_ray: &Line2D, _seg: &Line2D) -> Option<f32> {
    todo!();
}
